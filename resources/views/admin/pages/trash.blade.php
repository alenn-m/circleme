...
@section("content")
    ...
    <div class="row">
        <div class="col-xs-12">
            <a href="{{ URL::action('Admin\PagesController@index') }}" class="btn btn-primary btn-sm">{{ trans("admin.goBack") }}</a>
        </div>
    </div>
    <br/>
    <div class="row">
                        ...
                        <tr>
                            ...
                            <td>
                                {!! Form::open(["url" => URL::action("Admin\PagesController@destroy", $page->id), "method" => "delete"]) !!}
                                    ...
                                    <a href="{{ URL::action('Admin\PagesController@restore', $page->id) }}" class="btn btn-warning btn-sm  ">{{ trans("admin.restore") }}</a>
